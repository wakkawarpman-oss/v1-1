            ...
            <Card className="calc-surface overflow-hidden">
              ...
              <CardContent className="space-y-3 px-3 sm:px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {[
                    { tab: 'windprofile',   accent: true,  tag: '🆕 Профіль вітру',  title: 'Профіль вітру',                desc: 'ISO 4354 — швидкість вітру на висоті за 8 класами рельєфу.' },
                    { tab: 'thermalcooling',accent: true,  tag: '🆕 Охолодження',   title: 'Ram-Air охолодження',          desc: 'Мінімальна площа NACA-повітрозабірника для відведення тепла ESC/мотора.' },
                    { tab: 'acoustic',      accent: true,  tag: '🆕 Акустика',      title: 'Акустичний підпис',            desc: 'Шум пропелера в дБ(A) — кількість лопатей, Mach, відстань, мультиротор.' },
                    { tab: 'slipstream',    accent: true,  tag: '🆕 Слід гвинта',   title: 'Слід гвинта (Slipstream)',     desc: 'Actuator disk — пропвош БПЛА, динамічний тиск у сліді та опір тіл.' },
                    { tab: 'perfcalc',     accent: true,  tag: 'Характеристики', title: 'Продуктивність літака',      desc: 'Потужність, швидкість Карсона, зрив, кут набору, тяга/вага.' },
                    { tab: 'xcoptercalc',  accent: true,  tag: 'Мультиротор',    title: 'Мультиротор',                desc: 'Час висіння, запас тяги, витрати потужності, оцінка вильоту.' },
                    { tab: 'propcalc',     accent: false, tag: 'Мотор',          title: 'Мотор і пропелер',           desc: 'Підбір пропелера, тяга, струм і потужність приводу.' },
                    { tab: 'cgcalc',       accent: false, tag: 'Центр ваги',     title: 'Центр ваги',                 desc: 'Центр ваги літака за секціями та позицією компонентів.' },
                    { tab: 'fieldops',     accent: true,  tag: '🆕 Польові',     title: 'Польові рішення',            desc: 'Допуск до вильоту, точка повернення Bingo RTL, інтегральна оцінка місії.' },
                    { tab: 'aeronav',      accent: true,  tag: 'Аеронавігація',  title: 'Аеродинаміка і маршрут',    desc: 'Reynolds, ортодромія, локсодромія, поправка на вітер.' },
                    { tab: 'coords',       accent: false, tag: 'Координати',     title: 'Системи координат',          desc: 'ECEF, ENU, UTM, Haversine, азимут, точка призначення.' },
                    { tab: 'engineering',  accent: true,  tag: 'Інженерія',      title: 'Авіаційна інженерія',        desc: 'TAS/EAS, дальність Бреге, CLmax, швидкість підйому, ефективність.' },
                    { tab: 'avionics',     accent: false, tag: 'Авіоніка',       title: 'Авіоніка і електроніка',     desc: 'Втрати ESC, кабелі, пульсації, чутливість приймача, дальність.' },
                    { tab: 'geometry',     accent: false, tag: 'Геометрія',      title: 'Геометрія літака',           desc: 'AR, MAC, звуження крила, хвіст, товщина профілю, washout.' },
                    { tab: 'environment',  accent: true,  tag: 'Середовище',     title: 'Зовнішні фактори',           desc: 'Пориви, EDR, висотна щільність, нижня хмарність, обмерзання.' },
                    { tab: 'radiohorizon', accent: true,  tag: 'Радіо',          title: 'Радіогоризонт і радар',      desc: 'Горизонт прямої видимості, k-фактор, FSPL, повітряно-наземний лінк.' },
                    { tab: 'frequency',    accent: false, tag: 'Частоти',        title: 'Частотні інструменти',       desc: 'Частоти, Wi-Fi канали, ефект Доплера, фільтри, інтермодуляція.' },
                    { tab: 'dronetools',   accent: false, tag: 'Польові інстр.', title: 'Польові інструменти',        desc: 'МСА, LiPo, тяга, одиниці, енергія батареї, геометрія рами.' },
                    { tab: 'soldering',    accent: true,  tag: 'Паяння',         title: 'Паяння і монтаж',            desc: 'Тепловкладення, опір нагрівача, профіль оплавлення, трафарет.' },
                    { tab: 'ballistics',   accent: true,  tag: 'Балістика',      title: 'Балістика скидання',         desc: 'Дальність падіння, час польоту, швидкість удару — з опором і без.' },
                    { tab: 'ew',           accent: true,  tag: 'РЕБ',            title: 'РЕБ — Стійкість лінку',     desc: 'Відношення завада/сигнал, штраф загороджувача, захист ELRS/LoRa, дальність РЕБ.' },
                    { tab: 'optics',       accent: false, tag: 'Оптика',         title: 'Оптика, GSD та радіоканал', desc: 'Роздільна здатність знімку, дальність виявлення, бюджет лінку.' },
                    { tab: 'battery',      accent: false, tag: 'Батарея',        title: 'Конструктор батарейного паку',desc: 'S/P конфігурація, внутрішній опір, Ragone, C-рейт, ємність і напруга паку.' },
